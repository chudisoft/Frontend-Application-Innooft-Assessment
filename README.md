...
# 📖 [Product-Manager] <a name="about-project"></a>
...
**[Product-Manager]** is a project that allows a user to select a product of music and view the list of all songs in that product grouped by artists.
...
```sh
  git clone git@github.com:chudisoft/product-manager.git
  cd product-manager
  code .
```
-
...
- **[What languages where used?]**
  ...
  - [React, Redux, Html5, Javascript, and Tailwind CSS]
